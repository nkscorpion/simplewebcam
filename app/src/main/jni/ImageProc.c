...
void 
Java_com_camera_simplewebcam2_CameraPreview_pixeltobmp( JNIEnv* env,jobject thiz,jobject bitmap){
...
jint 
Java_com_camera_simplewebcam2_CameraPreview_prepareCamera( JNIEnv* env,jobject thiz, jint videoid){
...
jint 
Java_com_camera_simplewebcam2_CameraPreview_prepareCameraWithBase( JNIEnv* env,jobject thiz, jint videoid, jint videobase){
	
		int ret;

		camerabase = videobase;
	
		ret = Java_com_camera_simplewebcam2_CameraPreview_prepareCamera(env,thiz,videoid);
		return ret;
}

void 
Java_com_camera_simplewebcam2_CameraPreview_processCamera( JNIEnv* env,
										jobject thiz){
...
void 
Java_com_camera_simplewebcam2_CameraPreview_stopCamera(JNIEnv* env,jobject thiz){
